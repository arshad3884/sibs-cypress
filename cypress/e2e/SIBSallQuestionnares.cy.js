...
describe("SIBS Company Creation", () => {
  ...
  it('Submit Physical Risks Questionnaire and Download Report', () => {
    ...
    companyPage.gotoAdditionalInfo()
    companyPage.openQuestionnaire(questionName)
    questionPage.addAsset(
      'Solar Plant A',
      'Energy Production Unit: Solar / Photovoltaic Plant',
      ...
      {
        relevanceAssetValue: 'Critical',
        relevanceJustificationAssetValue: 'Main production site.',
        relevanceBusinessVolume: 'High Relevant',
        relevanceJustificationBusinessVolume: 'Majority of turnover.',
        insuranceCoverage: 'Yes',
        insuranceCoverageOptions: ['Fire', 'Floods']
      }
    )
    questionPage.selectRiskPlan('Earthquake', 'No', 'No')
